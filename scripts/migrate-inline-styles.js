...
const EXACT = {
  ...
  'align-items:center': 'items-center',
  'margin-bottom:.65rem;flex-wrap:wrap;gap:.5rem': 'toolbar-row',
  'width:16px;height:16px;accent-color:#1a56a0': 'chk-brand',
  'width:16px;height:16px;accent-color:#5b21b6': 'chk-purple',
  'accent-color:#1a56a0': 'chk-brand',
  'accent-color:#5b21b6': 'chk-purple',
  'font-size:20px': 'font-20',
  'font-weight:500': 'fw-500',
  'opacity:.75': 'opacity-75',
  'opacity:.8': 'opacity-80',
  'min-width:160px': 'min-w-160',
  'max-width:120px': 'max-w-120',
  'width:220px': 'w-220',
  'width:200px': 'w-200',
  'width:230px': 'w-230',
  'width:150px': 'w-150',
  'min-width:520px': 'min-w-520',
  'line-height:1.45': 'leading-normal',
  'line-height:1.7': 'leading-relaxed',
  'padding:1rem': 'p-md',
  'grid-template-columns:1fr 1fr 1fr': 'grid-cols-3',
  'max-height:min(420px,55vh)': 'max-h-slip-table',
  'margin:.35rem 0': 'my-sm',
  'margin:0 0 .75rem': 'mb-lg m-0',
  'margin-top:.25rem': 'mt-xs',
  'background:#f0f0fd;border-color:#c4b5fd': 'card-cuti-purple',
  'padding:8px;border:1px solid #c4b5fd': 'cuti-cb-label',
  'background:#f5f0ff;border:1.5px solid #c4b5fd;padding:1rem': 'card-thr-panel',
  'padding:6px 10px;border:1.5px solid #dde1e9;font-family:inherit;outline:none': 'audit-select',
  'background:#e8f0fb;padding:.85rem;border:1px solid #c5d9f5': 'surface-prs-hk rounded-sm',
};
